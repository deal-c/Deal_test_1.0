...
import com.first.yuliang.deal_community.wheel.OnWheelChangedListener;
...
/**
 * Created by vanex on 2016/10/25.
 */

public class MyCity extends Dialog {
    ...
    private List<Province> mProvinces = new ArrayList<Province>();
